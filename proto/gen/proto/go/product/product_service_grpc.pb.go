...
const (
	ProductService_CreateProduct_FullMethodName      = "/shinkansen.product.ProductService/CreateProduct"
	ProductService_GetProduct_FullMethodName         = "/shinkansen.product.ProductService/GetProduct"
	ProductService_ListProducts_FullMethodName       = "/shinkansen.product.ProductService/ListProducts"
	ProductService_UpdateProduct_FullMethodName      = "/shinkansen.product.ProductService/UpdateProduct"
	ProductService_DeleteProduct_FullMethodName      = "/shinkansen.product.ProductService/DeleteProduct"
	ProductService_SearchProducts_FullMethodName     = "/shinkansen.product.ProductService/SearchProducts"
	ProductService_GetProductVariants_FullMethodName = "/shinkansen.product.ProductService/GetProductVariants"
)
...
type ProductServiceClient interface {
	...
	DeleteProduct(ctx context.Context, in *DeleteProductRequest, opts ...grpc.CallOption) (*shared.Empty, error)
...
func (c *productServiceClient) DeleteProduct(ctx context.Context, in *DeleteProductRequest, opts ...grpc.CallOption) (*shared.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *productServiceClient) GetProductVariants(ctx context.Context, in *GetProductVariantsRequest, opts ...grpc.CallOption) (*GetProductVariantsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetProductVariantsResponse)
	err := c.cc.Invoke(ctx, ProductService_GetProductVariants_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProductServiceServer interface {
	...
	DeleteProduct(context.Context, *DeleteProductRequest) (*shared.Empty, error)
...
func (UnimplementedProductServiceServer) DeleteProduct(context.Context, *DeleteProductRequest) (*shared.Empty, error) {
...
func (UnimplementedProductServiceServer) GetProductVariants(context.Context, *GetProductVariantsRequest) (*GetProductVariantsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetProductVariants not implemented")
}
...
func _ProductService_GetProductVariants_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProductService_GetProductVariants_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).GetProductVariants(ctx, req.(*GetProductVariantsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ProductService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "shinkansen.product.ProductService",
