...
const (
	InventoryService_GetStock_FullMethodName          = "/shinkansen.inventory.InventoryService/GetStock"
	InventoryService_ReserveStock_FullMethodName      = "/shinkansen.inventory.InventoryService/ReserveStock"
	InventoryService_ReleaseStock_FullMethodName      = "/shinkansen.inventory.InventoryService/ReleaseStock"
	InventoryService_UpdateStock_FullMethodName       = "/shinkansen.inventory.InventoryService/UpdateStock"
	InventoryService_GetStockMovements_FullMethodName = "/shinkansen.inventory.InventoryService/GetStockMovements"
)
...
type InventoryServiceClient interface {
	...
	ReleaseStock(ctx context.Context, in *ReleaseStockRequest, opts ...grpc.CallOption) (*shared.Empty, error)
	UpdateStock(ctx context.Context, in *UpdateStockRequest, opts ...grpc.CallOption) (*shared.Empty, error)
	GetStockMovements(ctx context.Context, in *GetStockMovementsRequest, opts ...grpc.CallOption) (*GetStockMovementsResponse, error)
}
...
func (c *inventoryServiceClient) ReleaseStock(ctx context.Context, in *ReleaseStockRequest, opts ...grpc.CallOption) (*shared.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *inventoryServiceClient) UpdateStock(ctx context.Context, in *UpdateStockRequest, opts ...grpc.CallOption) (*shared.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(shared.Empty)
...
func (c *inventoryServiceClient) GetStockMovements(ctx context.Context, in *GetStockMovementsRequest, opts ...grpc.CallOption) (*GetStockMovementsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetStockMovementsResponse)
	err := c.cc.Invoke(ctx, InventoryService_GetStockMovements_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InventoryServiceServer interface {
	...
	ReleaseStock(context.Context, *ReleaseStockRequest) (*shared.Empty, error)
	UpdateStock(context.Context, *UpdateStockRequest) (*shared.Empty, error)
	GetStockMovements(context.Context, *GetStockMovementsRequest) (*GetStockMovementsResponse, error)
}
...
func (UnimplementedInventoryServiceServer) ReleaseStock(context.Context, *ReleaseStockRequest) (*shared.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method ReleaseStock not implemented")
}
func (UnimplementedInventoryServiceServer) UpdateStock(context.Context, *UpdateStockRequest) (*shared.Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method UpdateStock not implemented")
}
func (UnimplementedInventoryServiceServer) GetStockMovements(context.Context, *GetStockMovementsRequest) (*GetStockMovementsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetStockMovements not implemented")
}
...
func _InventoryService_GetStockMovements_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetStockMovementsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InventoryServiceServer).GetStockMovements(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InventoryService_GetStockMovements_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServiceServer).GetStockMovements(ctx, req.(*GetStockMovementsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var InventoryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "shinkansen.inventory.InventoryService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetStockMovements",
			Handler:    _InventoryService_GetStockMovements_Handler,
		},
	},
