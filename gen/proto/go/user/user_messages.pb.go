...
type UpdateAddressRequest struct {
	...
	Prefecture    *wrapperspb.StringValue `protobuf:"bytes,6,opt,name=prefecture,proto3" json:"prefecture,omitempty"`
	City          *wrapperspb.StringValue `protobuf:"bytes,7,opt,name=city,proto3" json:"city,omitempty"`
	AddressLine1  *wrapperspb.StringValue `protobuf:"bytes,8,opt,name=address_line1,json=addressLine1,proto3" json:"address_line1,omitempty"`
	AddressLine2  *wrapperspb.StringValue `protobuf:"bytes,9,opt,name=address_line2,json=addressLine2,proto3" json:"address_line2,omitempty"`
	IsDefault     *wrapperspb.BoolValue   `protobuf:"bytes,10,opt,name=is_default,json=isDefault,proto3" json:"is_default,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_user_user_messages_proto_rawDesc = "" +
	...
	"\taddresses\x18\x01 \x03(\v2\x18.shinkansen.user.AddressR\taddresses\"\xa4\x04\n" +
	"\x14UpdateAddressRequest\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x1d\n" +
	"\n" +
	"address_id\x18\x02 \x01(\tR\taddressId\x120\n" +
	...
	"postalCode\x12<\n" +
	"\n" +
	"prefecture\x18\x06 \x01(\v2\x1c.google.protobuf.StringValueR\n" +
	"prefecture\x120\n" +
	"\x04city\x18\a \x01(\v2\x1c.google.protobuf.StringValueR\x04city\x12A\n" +
	"\raddress_line1\x18\b \x01(\v2\x1c.google.protobuf.StringValueR\faddressLine1\x12A\n" +
	"\raddress_line2\x18\t \x01(\v2\x1c.google.protobuf.StringValueR\faddressLine2\x129\n" +
	"\n" +
	"is_default\x18\n" +
	" \x01(\v2\x1a.google.protobuf.BoolValueR\tisDefault\"K\n" +
	"\x15UpdateAddressResponse\x122\n" +
	"\aaddress\x18\x01 \x01(\v2\x18.shinkansen.user.AddressR\aaddress\"N\n" +
